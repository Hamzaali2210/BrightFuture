...
const NotesInfoData: React.FC<any> = ({
  ...
  console.log('indexindexindexindexindexindexindexindexindex', index, length);
        ...
        <View key={index} style={[styles.lesson]}>
          <View
            ...
            {item?.video_url?<View
              ...
              <Image
                ...
                //     : imagePath.radioBuy
                // }
                source={buyCourse ? imagePath.radioBuy : imagePath?.blueIcon}
                // source={
                //   buyCourse
                //     ? imagePath.radioBlue
                //     : index <= currentStep + 1
            ...
            {true && (
              <View
                style={[
                  styles.line,
                  {
                    backgroundColor: buyCourse ? '#D1D1D1' : colors.theme,
          ...
          <View style={[styles.lessonTitleContainer]}>
            <View style={[styles.chapterNameContainer]}>
              ...
              {item?.video_url && userDataPayload?.course_type_available && (
                <View
                  style={[
 ...
 {item?.video_url && (
      ...
      <ModalCard isModalVisible={typeModal} toggleModal={toggleTypeModal}>
        <AddTypeModal
      ...
      <ModalCard isModalVisible={notesModal} toggleModal={toggleNotesModal}>
        <Text
          style={{
            fontFamily: fontFamily.Poppins_SemiBold,
            color: colors.black,
...
const ChapterDetailProgress: React.FC<ChapterDetailProgressInterface> = ({
  ...
  const {mutate: canSeeChapter} = usePostData(
    `${endpoints.CANSEE}`,
    ['CAN_SEE_CHAPTER'],
    'post',
    (data: any) => {
    ...
    <View style={styles.container}>
      <TouchableOpacity
        ...
        <View style={[styles.btnContainer]}>
          {isPurchased && userData?.course_type_available ? (
            <Image
                ...
                {userData?.role === 2 && userData?.course_type_available && (
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Text
                      ...
                      {formatTime(
                        chapterDetail?.videos?.reduce(
                          (acc: number, curr: {duration: number}) =>
                            acc + curr?.duration,
                          0,
                        ),
                      )}
        ...
        {userData?.role === 2 && !isPurchased && price > 0 ? (
          <TouchableOpacity
            style={{
            ...
            {chapterDetail?.in_cart ? (
              ...
              <Image source={imagePath.cartBlue} resizeMode="cover" />
            )}
          </TouchableOpacity>
        ) : null}
        {/* <View>
